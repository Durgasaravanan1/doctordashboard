        ...
        <div className="mt-5">
          ...
          {tab === "billing" && (
            ...
            >
              ...
              <div className="mt-5 border-2 border-[#00B8DB] bg-[#EAFBFF] rounded-md p-4">
                <div className="text-[11px] font-extrabold text-black/70 uppercase">Accepted Payment Methods</div>
                <div className="mt-3 flex flex-wrap gap-2">
                  {allMethods.map((m) => (
                    <Pill key={m} active={billing.methods.includes(m)} onClick={() => toggleMethod(m)}>
                      {m.toUpperCase()}
                    </Pill>
                  ))}
                </div>
